    ...
    <Container>
      <AccordionGroup>
        <Accordion>
          ...
          <AccordionDetails>
            Geoguesser is a game in which players are randomly placed somewhere
            in Google Street View and need to guess what their exact location
            is.
            <br />
            <br />
            Previous literature [3][5] discusses using techniques like CNNs and
            transfer learning to analyze other image datasets to identify
            ...
            features that can help models classify an image. However, one of the
            shortcomings previous literature emphasizes is a lack of sufficient
        ...
        <Accordion>
          <AccordionSummary>Problem Definition and Motivation</AccordionSummary>
          <AccordionDetails>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <span>
              ...
              preprocessing method will be min-max scaling [2], which normalizes
              the 0-255 pixel range to 0-1 for easier model calculation, and is
              defined by{" "}
              ...
              [4]. Other than scaling the image array values, we will also clean
              our data by omitting countries (classes) with less than 100 images
              to prevent overfitting of some classes.
              <br />
              <br />
              As it is an image classification problem, our first model will be
              a CNN – a convolutional neural network. This will be a quite
        ...
        <Accordion>
          ...
          <AccordionDetails>
            An expected result of this project would be providing the program a
            picture(s) of a specific place, and it will guess what country the
            image(s) are from. Although we understand that the program will make
            mistakes on labeling the country, our hope is that it will be more
            informed and more accurate compared to the average uninformed
            person.
          </AccordionDetails>
        </Accordion>
        <Accordion>
          ...
          <AccordionDetails>
            [1] R. K., &quot;Geolocation - Geoguessr images (50k),&quot; Kaggle,{" "}
            <Link
              href="https://www.kaggle.com/datasets/ubitquitin/geolocation-geoguessr-images-50k"
              target="_blank"
            >
            ...
            <br />
            [2] A. Bhandari, &quot;Feature scaling: Engineering, Normalization,
            and standardization (updated 2024),&quot; Analytics Vidhya,{" "}
            <Link
            ...
            learning for medical image classification: a literature review. BMC
            Med Imaging 22, 69 (2022).{" "}
            <Link
            ...
            Matas, J., Sebe, N., Welling, M. (eds) Computer Vision – ECCV 2016.
            ECCV 2016. Lecture Notes in Computer Science(), vol 9912. Springer,
            Cham.{" "}
            <Link
